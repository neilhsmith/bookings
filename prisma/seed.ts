...
async function main() {
  ...
  const posts = [
    ...
    },
    {
      ...
      content:
        "TanStack Start is an amazing full-stack React framework. Here are some key features:\n\n- File-based routing\n- Server-side rendering\n- Built-in data fetching\n- TypeScript first",
      userId: testUserId,
    },
    {
      title: "Database Integration",
      content:
        "Adding Prisma and SQLite to a TanStack Start project is straightforward.\n\nThe type safety and developer experience is excellent.",
      userId: testUserId,
    },
  ];
